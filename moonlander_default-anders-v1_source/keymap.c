...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_DELETE,      KC_Q,           KC_W,           KC_F,           KC_P,           KC_G,           KC_TRANSPARENT,                                 ST_MACRO_1,     KC_J,           KC_U,           KC_I,           KC_Y,           KC_SCLN,        KC_BSLS,        
    KC_BSPC,        KC_A,           KC_R,           KC_S,           KC_T,           KC_D,           KC_HYPR,                                                                        KC_MEH,         KC_H,           KC_N,           KC_E,           KC_L,           LT(2,KC_O),     MT(MOD_LGUI, KC_QUOTE),
